...
public partial class MOCVA : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sTSQL = "SELECT TrebuchetAttach.RecID, TrebuchetAttach.CreatedDateTime, TrebuchetAttach.AttachType, TrebuchetAttach.AttachFlags, TrebuchetAttach.FilePath, TrebuchetAttach.FileContents, TrebuchetAttach.FileExt, TrebuchetAttach.LastModTimeStamp FROM TrebuchetAttach INNER JOIN TrebuchetShortcuts ON TrebuchetAttach.RecID = TrebuchetShortcuts.TargetRecId INNER JOIN ChangeRequest ON TrebuchetShortcuts.OwningBusObRecId = ChangeRequest.RecID where ChangeRequest.RecID = '" + Request.QueryString["RecID"] + "'";
    ...
    <a target='_blank' href='DocHandler.ashx?RecId=" + dt.Rows[i]["RecId"].ToString();
            ...
            Response.Write("This MOC has no attachments");
        }
