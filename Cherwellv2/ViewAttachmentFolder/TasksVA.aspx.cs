...
public partial class TasksVA : System.Web.UI.Page
{
    ...
    <a target='_blank' href='DocHandler.ashx?RecId=" + dt.Rows[i]["RecId"].ToString();
            ...
            Response.Write("This task has no attachments");
        }
