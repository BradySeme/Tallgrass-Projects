...
public partial class ChangeVA : System.Web.UI.Page
{
    ...
    <a target='_blank' href='DocHandler.ashx?RecId=" + dt.Rows[i]["RecId"].ToString();
            ...
            Response.Write("This change has no attachments");
        }
