...
public partial class MOCTallgrass : System.Web.UI.Page 
{
    private string gridMessage = null;
    SqlDataService sqlDataService = new SqlDataService(ConfigurationManager.ConnectionStrings["MOCTallgrassConnectionString"].ConnectionString);
    ...
    protected void Page_LoadComplete(object sender, EventArgs e)
    {
        ...
        DataSet mocTypes = sqlDataService.ExecuteDataset("GetMOCTallgrassMOCTypes");
        ...
        DataSet statuses = sqlDataService.ExecuteDataset("GetMOCTallgrassStatuses");
        ...
        DataSet mocPriorities = sqlDataService.ExecuteDataset("GetMOCTallgrassMOCPriorities");
        ...
        DataSet mocYears = sqlDataService.ExecuteDataset("GetMOCTallgrassMOCYears");
        ...
        DataSet mocChangeTypes = sqlDataService.ExecuteDataset("GetMOCTallgrassMOCChangeTypes");
    ...
    {
        RadGrid1.DataSource = sqlDataService.ExecuteDataset("GetMOCTallgrassMOCs");
    }
    ...
    protected void SearchButton_OnClick(object sender, EventArgs e)
    {
        ...
        RadGrid1.DataSource = sqlDataService.ExecuteDataset("SearchMOCTallgrass", Constants.MOCsSearchParameterNames, values,
