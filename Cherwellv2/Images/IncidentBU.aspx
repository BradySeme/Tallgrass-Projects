...
<%--            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                                    function JavaScriptIndexChanged(sender, args) {
                                        var clickedPage = args.get_pageIndex() + 1;

                                        var grid = $find('<%=RadGrid1.ClientID %>');

                                        grid.get_masterTableView().fireCommand("Page", "Page$" + clickedPage);
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True" AllowSorting="True"
                ...
                AllowPaging="True" OnItemUpdated="RadGrid1_ItemUpdated"
                AllowFilteringByColumn="True" OnItemDeleted="RadGrid1_ItemDeleted"
                OnItemInserted="RadGrid1_ItemInserted" CellSpacing="-1" GridLines="Both" OnPageIndexChanged="RadGrid1_PageIndexChanged" >
                <PagerStyle Mode="Advanced" />
                <GroupingSettings CollapseAllTooltip="Collapse all groups" CaseSensitive="false" />
                <ExportSettings ExportOnlyData="True">
                </ExportSettings>
                <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top"  DataKeyNames="RecID" EditMode="InPlace" HorizontalAlign="NotSet" TableLayout="Fixed" Width="100%">
