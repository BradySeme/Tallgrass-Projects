<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MOCTallgrass.aspx.cs" Inherits="MOCTallgrass" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True" AllowSorting="True" OnNeedDataSource="RadGrid1_NeedDataSource"
            AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowPaging="True"
            OnDataBound="RadGrid1_DataBound" GridLines="Both" PageSize="50" Width="330%">
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" DataKeyNames="MOCID" EditMode="EditForms" HorizontalAlign="NotSet" Width="100%" TableLayout="Fixed">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="Attachments" HeaderText="Attachments" HeaderStyle-Width="125px">
                        <ItemTemplate>
                            <asp:HyperLink ID="AttachButton" runat="server" NavigateUrl='<%#"~/ViewAttachmentFolder/MOCTGVA.aspx?MOCID=" + Eval("MOCID") %>' Text="Attachments" Target="_blank">
                            </asp:HyperLink>
                        </ItemTemplate>
